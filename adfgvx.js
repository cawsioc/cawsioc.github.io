...
// returns a adfgvx cipher encryption/decryption
...
encrypt = function() {
    ...
    var keyword1 = document.getElementById("ek1").value;
    var keyword2 = document.getElementById("ek2").value;
    document.getElementById("txboxout").value = adfgvxCipher("encrypt", plaintext, keyword1, keyword2);
};

decrypt = function() {
    var dciphertext = document.getElementById("rxboxin").value;
    var keyword1 = document.getElementById("dk1").value;
    var keyword2 = document.getElementById("dk2").value;
    document.getElementById("rxboxout").value = adfgvxCipher("decrypt", dciphertext, keyword1, keyword2);
};
